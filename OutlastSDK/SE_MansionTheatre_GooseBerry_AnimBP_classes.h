...
struct USE_MansionTheatre_GooseBerry_AnimBP_C : UAnimInstance {
	struct FPointerToUberGraphFrame UberGraphFrame; // 0x2c0(0x08)
	struct FAnimNode_Root AnimGraphNode_Root; // 0x2c8(0x30)
	struct FAnimNode_BlendListByBool AnimGraphNode_BlendListByBool_2; // 0x2f8(0xa8)
	struct FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer_4; // 0x3a0(0x80)
	struct FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer_3; // 0x420(0x80)
	struct FAnimNode_BlendListByBool AnimGraphNode_BlendListByBool; // 0x4a0(0xa8)
	...
	void AnimGraph(struct FPoseLink& AnimGraph); // Function SE_MansionTheatre_GooseBerry_AnimBP.SE_MansionTheatre_GooseBerry_AnimBP_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x201e6d4
	void ExecuteUbergraph_SE_MansionTheatre_GooseBerry_AnimBP(int32_t EntryPoint); // Function SE_MansionTheatre_GooseBerry_AnimBP.SE_MansionTheatre_GooseBerry_AnimBP_C.ExecuteUbergraph_SE_MansionTheatre_GooseBerry_AnimBP // (Final|UbergraphFunction) // @ game+0x201e6d4
};
