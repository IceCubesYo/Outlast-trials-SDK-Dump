...
struct FAkAndroidAdvancedInitializationSettings : FAkAdvancedInitializationSettingsWithMultiCoreRendering {
	bool RoundFrameSizeToHardwareSize; // 0x38(0x01)
...
struct FAkCommonInitializationSettings {
	...
	struct FAkSpatialAudioSettings SpatialAudioSettings; // 0x40(0x1c)
...
struct FAkSpatialAudioSettings {
	...
	bool EnableDiffractionOnReflections; // 0x10(0x01)
	bool EnableDirectPathDiffraction; // 0x11(0x01)
	char pad_12[0x2]; // 0x12(0x02)
	float MaximumPathLength; // 0x14(0x04)
	bool EnableTransmission; // 0x18(0x01)
...
struct FAkPS5AdvancedInitializationSettings : FAkAdvancedInitializationSettingsWithMultiCoreRendering {
	bool UseHardwareCodecLowLatencyMode; // 0x38(0x01)
	bool bVorbisHwAcceleration; // 0x39(0x01)
...
struct FAkXBoxOneAdvancedInitializationSettings : FAkAdvancedInitializationSettingsWithMultiCoreRendering {
	uint32_t ShapeDefaultPoolSize; // 0x38(0x04)
