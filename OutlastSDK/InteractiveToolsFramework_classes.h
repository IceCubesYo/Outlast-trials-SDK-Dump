...
struct UBrushBaseProperties : UInteractiveToolPropertySet {
	...
	struct URBVertexPaintUserSettings* VertexPaintSettingsData; // 0x78(0x08)
};

// Class InteractiveToolsFramework.RBVertexPaintUserSettings
// Size: 0x40 (Inherited: 0x28)
struct URBVertexPaintUserSettings : UObject {
	float DefaultUserBrushSize; // 0x28(0x04)
	float DefaultUserBrushFalloff; // 0x2c(0x04)
	float DefaultUserBrushStrength; // 0x30(0x04)
	bool DefaultUserbSpecifyRadius; // 0x34(0x01)
	char pad_35[0x3]; // 0x35(0x03)
	float DefaultUserBrushRadius; // 0x38(0x04)
...
struct UGizmoBaseComponent : UPrimitiveComponent {
	struct FLinearColor Color; // 0x490(0x10)
	float HoverSizeMultiplier; // 0x4a0(0x04)
	float PixelHitDistanceThreshold; // 0x4a4(0x04)
	char pad_4A8[0x8]; // 0x4a8(0x08)

	void UpdateWorldLocalState(bool bWorldIn); // Function InteractiveToolsFramework.GizmoBaseComponent.UpdateWorldLocalState // (Final|Native|Public) // @ game+0x3839d54
	void UpdateHoverState(bool bHoveringIn); // Function InteractiveToolsFramework.GizmoBaseComponent.UpdateHoverState // (Final|Native|Public) // @ game+0x3839ccc
};

// Class InteractiveToolsFramework.GizmoArrowComponent
// Size: 0x4d0 (Inherited: 0x4b0)
struct UGizmoArrowComponent : UGizmoBaseComponent {
	struct FVector Direction; // 0x4b0(0x0c)
	float Gap; // 0x4bc(0x04)
	float Length; // 0x4c0(0x04)
	float Thickness; // 0x4c4(0x04)
...
struct UGizmoBoxComponent : UGizmoBaseComponent {
	struct FVector Origin; // 0x4b0(0x0c)
	char pad_4BC[0x4]; // 0x4bc(0x04)
	struct FQuat Rotation; // 0x4c0(0x10)
	struct FVector Dimensions; // 0x4d0(0x0c)
	float LineThickness; // 0x4dc(0x04)
	bool bRemoveHiddenLines; // 0x4e0(0x01)
	bool bEnableAxisFlip; // 0x4e1(0x01)
...
struct UGizmoCircleComponent : UGizmoBaseComponent {
	struct FVector Normal; // 0x4b0(0x0c)
	float Radius; // 0x4bc(0x04)
	float Thickness; // 0x4c0(0x04)
	int32_t NumSides; // 0x4c4(0x04)
	bool bViewAligned; // 0x4c8(0x01)
	bool bOnlyAllowFrontFacingHits; // 0x4c9(0x01)
...
struct UGizmoTransformSource : UInterface {
	...
	void SetTransform(struct FTransform& NewTransform); // Function InteractiveToolsFramework.GizmoTransformSource.SetTransform // (Native|Public|HasOutParms|HasDefaults) // @ game+0x3839bfc
	struct FTransform GetTransform(); // Function InteractiveToolsFramework.GizmoTransformSource.GetTransform // (Native|Public|HasDefaults|Const) // @ game+0x3839a94
};
...
struct UGizmoAxisSource : UInterface {
	...
	bool HasTangentVectors(); // Function InteractiveToolsFramework.GizmoAxisSource.HasTangentVectors // (Native|Public|Const) // @ game+0x1d960bc
	void GetTangentVectors(struct FVector& TangentXOut, struct FVector& TangentYOut); // Function InteractiveToolsFramework.GizmoAxisSource.GetTangentVectors // (Native|Public|HasOutParms|HasDefaults|Const) // @ game+0x38399bc
	struct FVector GetOrigin(); // Function InteractiveToolsFramework.GizmoAxisSource.GetOrigin // (Native|Public|HasDefaults|Const) // @ game+0x383992c
	struct FVector GetDirection(); // Function InteractiveToolsFramework.GizmoAxisSource.GetDirection // (Native|Public|HasDefaults|Const) // @ game+0x38398f4
};
...
struct UGizmoClickTarget : UInterface {
	...
	void UpdateHoverState(bool bHovering); // Function InteractiveToolsFramework.GizmoClickTarget.UpdateHoverState // (Native|Public|Const) // @ game+0x1d559b4
};
...
struct UGizmoStateTarget : UInterface {
	...
	void EndUpdate(); // Function InteractiveToolsFramework.GizmoStateTarget.EndUpdate // (Native|Public) // @ game+0x1d96128
	void BeginUpdate(); // Function InteractiveToolsFramework.GizmoStateTarget.BeginUpdate // (Native|Public) // @ game+0x35bdc88
};
...
struct UGizmoFloatParameterSource : UInterface {
	...
	void SetParameter(float NewValue); // Function InteractiveToolsFramework.GizmoFloatParameterSource.SetParameter // (Native|Public) // @ game+0x3839af0
	float GetParameter(); // Function InteractiveToolsFramework.GizmoFloatParameterSource.GetParameter // (Native|Public|Const) // @ game+0x3839964
	void EndModify(); // Function InteractiveToolsFramework.GizmoFloatParameterSource.EndModify // (Native|Public) // @ game+0x38398e0
	void BeginModify(); // Function InteractiveToolsFramework.GizmoFloatParameterSource.BeginModify // (Native|Public) // @ game+0x1d96128
};
...
struct UGizmoVec2ParameterSource : UInterface {
	...
	void SetParameter(struct FVector2D& NewValue); // Function InteractiveToolsFramework.GizmoVec2ParameterSource.SetParameter // (Native|Public|HasOutParms|HasDefaults) // @ game+0x3839b78
	struct FVector2D GetParameter(); // Function InteractiveToolsFramework.GizmoVec2ParameterSource.GetParameter // (Native|Public|HasDefaults|Const) // @ game+0x383998c
	void EndModify(); // Function InteractiveToolsFramework.GizmoVec2ParameterSource.EndModify // (Native|Public) // @ game+0x38398e0
	void BeginModify(); // Function InteractiveToolsFramework.GizmoVec2ParameterSource.BeginModify // (Native|Public) // @ game+0x1d96128
};
...
struct UGizmoLineHandleComponent : UGizmoBaseComponent {
	struct FVector Normal; // 0x4b0(0x0c)
	float HandleSize; // 0x4bc(0x04)
	float Thickness; // 0x4c0(0x04)
	struct FVector Direction; // 0x4c4(0x0c)
	float Length; // 0x4d0(0x04)
	bool bImageScale; // 0x4d4(0x01)
...
struct UGizmoRectangleComponent : UGizmoBaseComponent {
	struct FVector DirectionX; // 0x4b0(0x0c)
	struct FVector DirectionY; // 0x4bc(0x0c)
	float OffsetX; // 0x4c8(0x04)
	float OffsetY; // 0x4cc(0x04)
	float LengthX; // 0x4d0(0x04)
	float LengthY; // 0x4d4(0x04)
	float Thickness; // 0x4d8(0x04)
	char SegmentFlags; // 0x4dc(0x01)
