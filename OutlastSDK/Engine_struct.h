...
// Enum Engine.ERBGameplayBlurType
enum class ERBGameplayBlurType : uint8 {
	None = 0,
	Gaussian = 1,
	Radial = 2,
	ERBGameplayBlurType_MAX = 3
};
...
enum class EBlendableLocation : uint8 {
	BL_AfterTonemappingBeforeFXAA = 0,
	BL_AfterTonemapping = 1,
	BL_BeforeTonemapping = 2,
	BL_BeforeTranslucency = 3,
	BL_ReplacingTonemapper = 4,
	BL_SSRInput = 5,
	BL_MAX = 6
};
...
enum class EStreamingVolumeUsage : uint8 {
	...
	SVB_InWorldNotRendered = 5,
	SVB_MAX = 6
};

// Enum Engine.ELightClipPlaneMode
enum class ELightClipPlaneMode : uint8 {
	None = 0,
	PositiveX = 1,
	NegativeX = 2,
	PositiveY = 3,
...
// Enum Engine.EMaterialConvertHDRType
enum class EMaterialConvertHDRType : uint8 {
	Convert_SRGBLinear_To_Rec2020Linear = 0,
	Convert_HDREncoded_To_HDRLinear = 1,
	Convert_HDRLinear_To_HDREncoded = 2,
	Convert_MAX = 3
};
...
// Enum Engine.ERBVolumetricFogLightType
enum class ERBVolumetricFogLightType : uint8 {
	VFLT_Point = 0,
	VFLT_Spot = 1,
	VFLT_Neon = 2,
	VFLT_MAX = 3
...
// Enum Engine.EReflectionUsageType
enum class EReflectionUsageType : uint8 {
	Default = 0,
	ReflectionAndDiffuseBounce = 1,
	ReflectionAndDiffuseTwoStates = 2,
	EReflectionUsageType_MAX = 3
};
...
// Enum Engine.ESkeletalMeshSectionPlatform
enum class ESkeletalMeshSectionPlatform : uint8 {
	All = 0,
	LowSpecOnly = 1,
	HighSpecOnly = 2,
	ESkeletalMeshSectionPlatform_MAX = 3
};
...
enum class TextureMipGenSettings : uint8 {
	...
	TMGS_Blur4 = 18,
	TMGS_Blur5 = 19,
	TMGS_DilateColor1 = 20,
	TMGS_DilateColor2 = 21,
	TMGS_DilateColor3 = 22,
	TMGS_DilateColor4 = 23,
	TMGS_DilateColor5 = 24,
	TMGS_DilateColor6 = 25,
	TMGS_DilateColor7 = 26,
	TMGS_DilateColor8 = 27,
	TMGS_DilateColor9 = 28,
	TMGS_DilateColor10 = 29,
	TMGS_DilateColor11 = 30,
	TMGS_DilateColor12 = 31,
	TMGS_DilateAlpha1 = 32,
	TMGS_DilateAlpha2 = 33,
	TMGS_DilateAlpha3 = 34,
	TMGS_DilateAlpha4 = 35,
	TMGS_DilateAlpha5 = 36,
	TMGS_DilateAlpha6 = 37,
	TMGS_DilateAlpha7 = 38,
	TMGS_DilateAlpha8 = 39,
	TMGS_DilateAlpha9 = 40,
	TMGS_DilateAlpha10 = 41,
	TMGS_DilateAlpha11 = 42,
	TMGS_DilateAlpha12 = 43,
	TMGS_Unfiltered = 44,
	TMGS_MAX = 45
};
...
// ScriptStruct Engine.RBExtraMoveData
// Size: 0x70 (Inherited: 0x00)
struct FRBExtraMoveData {
	struct FVector_NetQuantize10 ViewLocation; // 0x00(0x0c)
	float ViewYawLocalSpace; // 0x0c(0x04)
	struct FRBExtraSpecialMoveData SpecialMoveData; // 0x10(0x3c)
	char LocomotionModeEnum; // 0x4c(0x01)
	bool bIsSameInteractableAsPreviousMove; // 0x4d(0x01)
	char pad_4E[0x2]; // 0x4e(0x02)
	struct UObject* Interactable; // 0x50(0x08)
	struct APawn* PairedPawn; // 0x58(0x08)
	bool bIsPairedPawnLeader; // 0x60(0x01)
	char pad_61[0x3]; // 0x61(0x03)
	float stamina; // 0x64(0x04)
	float PawnTimestamp; // 0x68(0x04)
	char pad_6C[0x4]; // 0x6c(0x04)
};

// ScriptStruct Engine.RBExtraSpecialMoveData
// Size: 0x3c (Inherited: 0x00)
struct FRBExtraSpecialMoveData {
	bool bPredicted; // 0x00(0x01)
	char pad_1[0x3]; // 0x01(0x03)
	float StartedMovementTimestamp; // 0x04(0x04)
	int32_t SpecialMoveIndex; // 0x08(0x04)
	int32_t SpecialMoveEnum; // 0x0c(0x04)
	char SpecialMoveSubType; // 0x10(0x01)
	char pad_11[0x3]; // 0x11(0x03)
	struct FVector SpecialMoveOriginalPosition; // 0x14(0x0c)
	float SpecialMoveOriginalDirectionYaw; // 0x20(0x04)
	float SpecialMoveAdjustmentDuration; // 0x24(0x04)
	struct FVector SpecialMoveTargetPosition; // 0x28(0x0c)
	float SpecialMoveTargetDirectionYaw; // 0x34(0x04)
	bool bStopInteractionOnCompleted; // 0x38(0x01)
	bool bIsSameAsPreviousSpecialMove; // 0x39(0x01)
...
// ScriptStruct Engine.CompressedMoveFlags
// Size: 0x04 (Inherited: 0x00)
...
struct FPostProcessSettings {
	...
	char bOverride_HDRReconstructionChannelSaturation : 1; // 0x03(0x01)
	...
	char bOverride_FilmChannelMixerGreen : 1; // 0x04(0x01)
	char bOverride_FilmChannelMixerBlue : 1; // 0x04(0x01)
	...
	char bOverride_FilmShadowTintAmount : 1; // 0x05(0x01)
	char bOverride_FilmSlope : 1; // 0x05(0x01)
	...
	char bOverride_LensFlareMethod : 1; // 0x0b(0x01)
	...
	char bOverride_LensFlareTextureIndex : 1; // 0x0c(0x01)
	char bOverride_LensFlareSaturation : 1; // 0x0c(0x01)
	char bOverride_LensFlareSphericalFlareDistance : 1; // 0x0c(0x01)
	char bOverride_LensFlareChromaticAberrationSpacing : 1; // 0x0c(0x01)
	char bOverride_LensFlareHardness : 1; // 0x0c(0x01)
	char bOverride_LensFlareBokehSize : 1; // 0x0c(0x01)
	char bOverride_LensFlareBokehShape : 1; // 0x0d(0x01)
	char bOverride_LensFlareThreshold : 1; // 0x0d(0x01)
	char bOverride_VignetteIntensity : 1; // 0x0d(0x01)
	char bOverride_GrainIntensity : 1; // 0x0d(0x01)
	char bOverride_GrainJitter : 1; // 0x0d(0x01)
	char bOverride_GrainTexture : 1; // 0x0d(0x01)
	char bOverride_GrainTextureScale : 1; // 0x0d(0x01)
	char bOverride_AmbientOcclusionIntensity : 1; // 0x0d(0x01)
	char bOverride_AmbientOcclusionNightVisionIntensity : 1; // 0x0e(0x01)
	...
	char bOverride_AmbientOcclusionMaximumScreenSpaceSize : 1; // 0x0e(0x01)
	char bOverride_AmbientOcclusionPower : 1; // 0x0f(0x01)
	...
	char bOverride_DepthOfFieldFocalPosition : 1; // 0x16(0x01)
	char bOverride_DepthOfFieldFocalDistance : 1; // 0x16(0x01)
	char bOverride_DepthOfFieldUseFocalPosition : 1; // 0x16(0x01)
	char bOverride_DepthOfFieldFstop : 1; // 0x16(0x01)
	char bOverride_DepthOfFieldMinFstop : 1; // 0x16(0x01)
	char bOverride_DepthOfFieldBladeCount : 1; // 0x17(0x01)
	char bOverride_DepthOfFieldSensorWidth : 1; // 0x17(0x01)
	...
	char bOverride_DepthOfFieldNearBlurSize : 1; // 0x18(0x01)
	char bOverride_DepthOfFieldFarBlurSize : 1; // 0x18(0x01)
	char bOverride_DepthOfFieldFogMode : 1; // 0x18(0x01)
	char bOverride_DepthOfFieldFogDensityScale : 1; // 0x18(0x01)
	char bOverride_DepthOfFieldMethod : 1; // 0x18(0x01)
	...
	char bOverride_DepthOfFieldVignetteSize : 1; // 0x19(0x01)
	char bOverride_DepthOfFieldEnableNearBlur : 1; // 0x19(0x01)
	char bOverride_MotionBlurAmount : 1; // 0x19(0x01)
	char bOverride_MotionBlurMax : 1; // 0x19(0x01)
	char bOverride_MotionBlurTargetFPS : 1; // 0x19(0x01)
	char bOverride_MotionBlurPerObjectSize : 1; // 0x19(0x01)
	char bOverride_ScreenPercentage : 1; // 0x19(0x01)
	char bOverride_GameplayBlurType : 1; // 0x19(0x01)
	char bOverride_GameplayBlurIntensity : 1; // 0x1a(0x01)
	char bOverride_GameplayBlurFalloff : 1; // 0x1a(0x01)
	char bOverride_ScreenSpaceReflectionIntensity : 1; // 0x1a(0x01)
	char bOverride_ScreenSpaceReflectionQuality : 1; // 0x1a(0x01)
	char bOverride_ScreenSpaceReflectionMaxRoughness : 1; // 0x1a(0x01)
	char bOverride_ScreenSpaceReflectionRoughnessScale : 1; // 0x1a(0x01)
	char pad_1A_6 : 2; // 0x1a(0x01)
	...
	char bOverride_PathTracingFilterWidth : 1; // 0x1e(0x01)
	char bOverride_PathTracingEnableEmissive : 1; // 0x1e(0x01)
	char bOverride_PathTracingMaxPathExposure : 1; // 0x1e(0x01)
	char bOverride_PathTracingEnableDenoiser : 1; // 0x1e(0x01)
	char pad_1E_5 : 3; // 0x1e(0x01)
	...
	enum class EDepthOfFieldMethod DepthOfFieldMethod; // 0x23(0x01)
	enum class ETemperatureMethod TemperatureType; // 0x24(0x01)
	...
	float HDRReconstructionChannelSaturation; // 0x184(0x04)
	float FilmSlope; // 0x188(0x04)
	float FilmToe; // 0x18c(0x04)
	float FilmShoulder; // 0x190(0x04)
	float FilmBlackClip; // 0x194(0x04)
	float FilmWhiteClip; // 0x198(0x04)
	struct FLinearColor FilmWhitePoint; // 0x19c(0x10)
	struct FLinearColor FilmShadowTint; // 0x1ac(0x10)
	float FilmShadowTintBlend; // 0x1bc(0x04)
	float FilmShadowTintAmount; // 0x1c0(0x04)
	float FilmSaturation; // 0x1c4(0x04)
	struct FLinearColor FilmChannelMixerRed; // 0x1c8(0x10)
	struct FLinearColor FilmChannelMixerGreen; // 0x1d8(0x10)
	struct FLinearColor FilmChannelMixerBlue; // 0x1e8(0x10)
	float FilmContrast; // 0x1f8(0x04)
	float FilmToeAmount; // 0x1fc(0x04)
	float FilmHealAmount; // 0x200(0x04)
	float FilmDynamicRange; // 0x204(0x04)
	struct FLinearColor SceneColorTint; // 0x208(0x10)
	float SceneFringeIntensity; // 0x218(0x04)
	float ChromaticAberrationStartOffset; // 0x21c(0x04)
	float BloomIntensity; // 0x220(0x04)
	float BloomThreshold; // 0x224(0x04)
	float BloomSizeScale; // 0x228(0x04)
	float Bloom1Size; // 0x22c(0x04)
	float Bloom2Size; // 0x230(0x04)
	float Bloom3Size; // 0x234(0x04)
	float Bloom4Size; // 0x238(0x04)
	float Bloom5Size; // 0x23c(0x04)
	float Bloom6Size; // 0x240(0x04)
	struct FLinearColor Bloom1Tint; // 0x244(0x10)
	struct FLinearColor Bloom2Tint; // 0x254(0x10)
	struct FLinearColor Bloom3Tint; // 0x264(0x10)
	struct FLinearColor Bloom4Tint; // 0x274(0x10)
	struct FLinearColor Bloom5Tint; // 0x284(0x10)
	struct FLinearColor Bloom6Tint; // 0x294(0x10)
	float BloomConvolutionSize; // 0x2a4(0x04)
	...
	enum class ELensFlareMethod LensFlareMethod; // 0x35c(0x01)
	char pad_35D[0x3]; // 0x35d(0x03)
	float LensFlareIntensity; // 0x360(0x04)
	struct FLinearColor LensFlareTint; // 0x364(0x10)
	int32_t LensFlareTextureIndex; // 0x374(0x04)
	float LensFlareSaturation; // 0x378(0x04)
	float LensFlareSphericalFlareDistance; // 0x37c(0x04)
	float LensFlareChromaticAberrationSpacing; // 0x380(0x04)
	float LensFlareHardness; // 0x384(0x04)
	float LensFlareBokehSize; // 0x388(0x04)
	float LensFlareThreshold; // 0x38c(0x04)
	struct UTexture* LensFlareBokehShape; // 0x390(0x08)
	struct FLinearColor LensFlareTints[0x8]; // 0x398(0x80)
	float VignetteIntensity; // 0x418(0x04)
	float GrainJitter; // 0x41c(0x04)
	float GrainIntensity; // 0x420(0x04)
	char pad_424[0x4]; // 0x424(0x04)
	struct UTexture* GrainTexture; // 0x428(0x08)
	float GrainTextureScale; // 0x430(0x04)
	float AmbientOcclusionIntensity; // 0x434(0x04)
	float AmbientOcclusionNightVisionIntensity; // 0x438(0x04)
	...
	float AmbientOcclusionMaximumScreenSpaceSize; // 0x448(0x04)
	float AmbientOcclusionFadeDistance; // 0x44c(0x04)
	float AmbientOcclusionFadeRadius; // 0x450(0x04)
	float AmbientOcclusionDistance; // 0x454(0x04)
	float AmbientOcclusionPower; // 0x458(0x04)
	float AmbientOcclusionBias; // 0x45c(0x04)
	float AmbientOcclusionQuality; // 0x460(0x04)
	float AmbientOcclusionMipBlend; // 0x464(0x04)
	float AmbientOcclusionMipScale; // 0x468(0x04)
	float AmbientOcclusionMipThreshold; // 0x46c(0x04)
	float AmbientOcclusionTemporalBlendWeight; // 0x470(0x04)
	char RayTracingAO : 1; // 0x474(0x01)
	char pad_474_1 : 7; // 0x474(0x01)
	char pad_475[0x3]; // 0x475(0x03)
	int32_t RayTracingAOSamplesPerPixel; // 0x478(0x04)
	float RayTracingAOIntensity; // 0x47c(0x04)
	float RayTracingAORadius; // 0x480(0x04)
	struct FLinearColor IndirectLightingColor; // 0x484(0x10)
	float IndirectLightingIntensity; // 0x494(0x04)
	enum class ERayTracingGlobalIlluminationType RayTracingGIType; // 0x498(0x01)
	char pad_499[0x3]; // 0x499(0x03)
	int32_t RayTracingGIMaxBounces; // 0x49c(0x04)
	int32_t RayTracingGISamplesPerPixel; // 0x4a0(0x04)
	float ColorGradingIntensity; // 0x4a4(0x04)
	struct UTexture* ColorGradingLUT; // 0x4a8(0x08)
	float DepthOfFieldSensorWidth; // 0x4b0(0x04)
	float DepthOfFieldFocalDistance; // 0x4b4(0x04)
	struct FVector DepthOfFieldFocalPosition; // 0x4b8(0x0c)
	float DepthOfFieldDepthBlurAmount; // 0x4c4(0x04)
	float DepthOfFieldDepthBlurRadius; // 0x4c8(0x04)
	float DepthOfFieldFocalRegion; // 0x4cc(0x04)
	float DepthOfFieldNearTransitionRegion; // 0x4d0(0x04)
	float DepthOfFieldFarTransitionRegion; // 0x4d4(0x04)
	float DepthOfFieldScale; // 0x4d8(0x04)
	float DepthOfFieldNearBlurSize; // 0x4dc(0x04)
	float DepthOfFieldFarBlurSize; // 0x4e0(0x04)
	bool DepthOfFieldFogMode; // 0x4e4(0x01)
	bool DepthOfFieldUseFocalPosition; // 0x4e5(0x01)
	char pad_4E6[0x2]; // 0x4e6(0x02)
	float DepthOfFieldFogDensityScale; // 0x4e8(0x04)
	...
	enum class EReflectionsType ReflectionsType; // 0x53c(0x01)
	char pad_53D[0x3]; // 0x53d(0x03)
	float ScreenSpaceReflectionIntensity; // 0x540(0x04)
	float ScreenSpaceReflectionQuality; // 0x544(0x04)
	float ScreenSpaceReflectionMaxRoughness; // 0x548(0x04)
	float RayTracingReflectionsMaxRoughness; // 0x54c(0x04)
	int32_t RayTracingReflectionsMaxBounces; // 0x550(0x04)
	int32_t RayTracingReflectionsSamplesPerPixel; // 0x554(0x04)
	enum class EReflectedAndRefractedRayTracedShadows RayTracingReflectionsShadows; // 0x558(0x01)
	char RayTracingReflectionsTranslucency : 1; // 0x559(0x01)
	char pad_559_1 : 7; // 0x559(0x01)
	enum class ETranslucencyType TranslucencyType; // 0x55a(0x01)
	char pad_55B[0x1]; // 0x55b(0x01)
	float RayTracingTranslucencyMaxRoughness; // 0x55c(0x04)
	int32_t RayTracingTranslucencyRefractionRays; // 0x560(0x04)
	int32_t RayTracingTranslucencySamplesPerPixel; // 0x564(0x04)
	enum class EReflectedAndRefractedRayTracedShadows RayTracingTranslucencyShadows; // 0x568(0x01)
	char RayTracingTranslucencyRefraction : 1; // 0x569(0x01)
	char pad_569_1 : 7; // 0x569(0x01)
	char pad_56A[0x2]; // 0x56a(0x02)
	int32_t PathTracingMaxBounces; // 0x56c(0x04)
	int32_t PathTracingSamplesPerPixel; // 0x570(0x04)
	float PathTracingFilterWidth; // 0x574(0x04)
	char PathTracingEnableEmissive : 1; // 0x578(0x01)
	char pad_578_1 : 7; // 0x578(0x01)
	char pad_579[0x3]; // 0x579(0x03)
	float PathTracingMaxPathExposure; // 0x57c(0x04)
	char PathTracingEnableDenoiser : 1; // 0x580(0x01)
	char pad_580_1 : 7; // 0x580(0x01)
	char pad_581[0x3]; // 0x581(0x03)
	float LPVFadeRange; // 0x584(0x04)
	float LPVDirectionalOcclusionFadeRange; // 0x588(0x04)
	float ScreenPercentage; // 0x58c(0x04)
	enum class ERBGameplayBlurType GameplayBlurType; // 0x590(0x01)
	char pad_591[0x3]; // 0x591(0x03)
	float GameplayBlurIntensity; // 0x594(0x04)
	float GameplayBlurFalloff; // 0x598(0x04)
	char pad_59C[0x4]; // 0x59c(0x04)
	struct FWeightedBlendables WeightedBlendables; // 0x5a0(0x10)
};
...
// ScriptStruct Engine.DefaultAnimCompressionSettings
// Size: 0x28 (Inherited: 0x00)
struct FDefaultAnimCompressionSettings {
	struct TArray<struct FString> AssetWildcards; // 0x00(0x10)
	struct FSoftObjectPath BoneCompressionSettings; // 0x10(0x18)
};
...
struct FAnimNode_SequencePlayer : FAnimNode_AssetPlayerBase {
	...
	bool bFullRootMotion; // 0x7d(0x01)
	bool bSpecialMove; // 0x7e(0x01)
...
struct FAnimSingleNodeInstanceProxy : FAnimInstanceProxy {
	char pad_770[0x150]; // 0x770(0x150)
};
...
struct FBakedAnimationState {
	struct FName StateName; // 0x00(0x08)
	struct FName GameplayStateName; // 0x08(0x08)
...
struct FAssetManagerSearchRules {
	...
	struct UObject* AssetBaseClass; // 0x30(0x08)
...
struct FCameraShakeScrubParams {
	...
	struct FMinimalViewInfo POV; // 0x10(0x640)
};
...
struct FMinimalViewInfo {
	...
	float NearClipPlane; // 0x30(0x04)
	char bDisablePrecomputedVisibility : 1; // 0x34(0x01)
	char bDisableUpscalersAndTemporalAA : 1; // 0x34(0x01)
	char bDisableSubsurfaceScattering : 1; // 0x34(0x01)
	...
	struct FPostProcessSettings PostProcessSettings; // 0x40(0x5b0)
	struct FVector2D OffCenterProjectionOffset; // 0x5f0(0x08)
...
struct FChildActorComponentInstanceData : FSceneComponentInstanceData {
	struct AActor* ChildActorClass; // 0xf8(0x08)
	struct FName ChildActorName; // 0x100(0x08)
	struct TArray<struct FChildActorAttachedActorInfo> AttachedActors; // 0x108(0x10)
...
struct FConstraintProfileProperties {
	...
	float LinearPlasticityThreshold; // 0x14(0x04)
	float AngularBreakThreshold; // 0x18(0x04)
	float AngularPlasticityThreshold; // 0x1c(0x04)
	...
	char bDisableCollision : 1; // 0x110(0x01)
	char bParentDominates : 1; // 0x110(0x01)
	char bEnableProjection : 1; // 0x110(0x01)
	char bEnableSoftProjection : 1; // 0x110(0x01)
	char bAngularBreakable : 1; // 0x110(0x01)
	char bAngularPlasticity : 1; // 0x110(0x01)
	char bLinearBreakable : 1; // 0x110(0x01)
	char bLinearPlasticity : 1; // 0x110(0x01)
...
struct FLightmassPrimitiveSettings {
	...
	char bSelfShadowOnly : 1; // 0x00(0x01)
...
struct FLightmassLightSettings {
	...
	float ShadowResolutionScale; // 0x0c(0x04)
	bool bBakeIndirectOnMovable; // 0x10(0x01)
	char pad_11[0x3]; // 0x11(0x03)
	int32_t HybridLightChannel; // 0x14(0x04)
	float ReverseSpotInnerConeAngle; // 0x18(0x04)
	float ReverseSpotOuterConeAngle; // 0x1c(0x04)
	bool bForceAffectsWorld; // 0x20(0x01)
	bool bUseAreaShadowsForStationaryLight; // 0x21(0x01)
...
struct FLightmassDirectionalLightSettings : FLightmassLightSettings {
	float LightSourceAngle; // 0x24(0x04)
};
...
struct FInstancedStaticMeshComponentInstanceData : FSceneComponentInstanceData {
	struct UStaticMesh* StaticMesh; // 0xf8(0x08)
	struct FInstancedStaticMeshLightMapInstanceData CachedStaticLighting; // 0x100(0x40)
	struct TArray<struct FInstancedStaticMeshInstanceData> PerInstanceSMData; // 0x140(0x10)
	struct TArray<float> PerInstanceSMCustomData; // 0x150(0x10)
	char pad_168[0x18]; // 0x168(0x18)
	int32_t InstancingRandomSeed; // 0x180(0x04)
...
// ScriptStruct Engine.LensFlareElement
// Size: 0x90 (Inherited: 0x00)
struct FLensFlareElement {
	struct FName ElementName; // 0x00(0x08)
	float RayDistance; // 0x08(0x04)
	bool bIsEnabled; // 0x0c(0x01)
	bool bUseSourceDistance; // 0x0d(0x01)
	bool bNormalizeRadialDistance; // 0x0e(0x01)
	bool bModulateColorBySource; // 0x0f(0x01)
	struct FVector Size; // 0x10(0x0c)
	char pad_1C[0x4]; // 0x1c(0x04)
	struct UMaterialInterface* Material; // 0x20(0x08)
	bool bOrientTowardsSource; // 0x28(0x01)
	char pad_29[0x3]; // 0x29(0x03)
	struct FSimpleLensFlareFloatCurve Scaling; // 0x2c(0x0c)
	struct FSimpleLensFlareFloatCurve AxisScaling; // 0x38(0x0c)
	struct FSimpleLensFlareFloatCurve Rotation; // 0x44(0x0c)
	struct FSimpleLensFlareColorCurve Color; // 0x50(0x24)
	struct FSimpleLensFlareVectorCurve Offset; // 0x74(0x1c)
};

// ScriptStruct Engine.SimpleLensFlareVectorCurve
// Size: 0x1c (Inherited: 0x00)
struct FSimpleLensFlareVectorCurve {
	struct FVector Min; // 0x00(0x0c)
	struct FVector Max; // 0x0c(0x0c)
	float Power; // 0x18(0x04)
};

// ScriptStruct Engine.SimpleLensFlareColorCurve
// Size: 0x24 (Inherited: 0x00)
struct FSimpleLensFlareColorCurve {
	struct FLinearColor Min; // 0x00(0x10)
	struct FLinearColor Max; // 0x10(0x10)
	float Power; // 0x20(0x04)
};

// ScriptStruct Engine.SimpleLensFlareFloatCurve
// Size: 0x0c (Inherited: 0x00)
struct FSimpleLensFlareFloatCurve {
	float Min; // 0x00(0x04)
	float Max; // 0x04(0x04)
	float Power; // 0x08(0x04)
};
...
struct FPrecomputedLightInstanceData : FSceneComponentInstanceData {
	...
	struct FGuid LightGuid; // 0x130(0x10)
	int32_t PreviewShadowMapChannel; // 0x140(0x04)
...
struct FMaterialCachedExpressionData {
	struct FMaterialCachedParameters Parameters; // 0x00(0x150)
	...
	char bHasRuntimeVirtualTextureOutput : 1; // 0x1d0(0x01)
	char bHasSceneColor : 1; // 0x1d0(0x01)
	char bHasHDRPostProcessExpressions : 1; // 0x1d0(0x01)
	char pad_1D0_3 : 5; // 0x1d0(0x01)
...
struct FMaterialCachedParameters {
	struct FMaterialCachedParameterEntry RuntimeEntries[0x5]; // 0x00(0xf0)
...
struct FMaterialInstanceBasePropertyOverrides {
	...
	char bOverride_ResponsiveAA : 1; // 0x00(0x01)
	char TwoSided : 1; // 0x00(0x01)
	char DitheredLODTransition : 1; // 0x01(0x01)
	char ResponsiveAA : 1; // 0x01(0x01)
...
// Size: 0x11c (Inherited: 0x00)
struct FPhysicsConstraintProfileHandle {
	struct FConstraintProfileProperties ProfileProperties; // 0x00(0x114)
	struct FName ProfileName; // 0x114(0x08)
};
...
struct FTViewTarget {
	...
	char pad_8[0x8]; // 0x08(0x08)
	struct FMinimalViewInfo POV; // 0x10(0x640)
	struct APlayerState* PlayerState; // 0x650(0x08)
...
struct FPrecomputedSkyLightInstanceData : FSceneComponentInstanceData {
	struct FGuid LightGuid; // 0xf8(0x10)
	float AverageBrightness; // 0x108(0x04)
	char pad_114[0x9c]; // 0x114(0x9c)
};
...
struct FSplineInstanceData : FSceneComponentInstanceData {
	bool bSplineHasBeenEdited; // 0xf8(0x01)
	struct FSplineCurves SplineCurves; // 0x100(0x70)
	struct FSplineCurves SplineCurvesPreUCS; // 0x170(0x70)
};
...
struct FSplineMeshInstanceData : FSceneComponentInstanceData {
	struct FVector StartPos; // 0xf8(0x0c)
	struct FVector EndPos; // 0x104(0x0c)
	struct FVector StartTangent; // 0x110(0x0c)
	struct FVector EndTangent; // 0x11c(0x0c)
};
...
struct FTextureLODGroup {
	...
	bool HighPriorityLoad; // 0x51(0x01)
	bool DuplicateNonOptionalMips; // 0x52(0x01)
...
struct FLightmassWorldInfoSettings {
	...
	char bSeparateVolumetricLightmapData : 1; // 0x25(0x01)
	char bGenerateAmbientDarknessVolumeData : 1; // 0x25(0x01)
	...
	char bBuildVolumetricFogReflectionVolume : 1; // 0x4c(0x01)
