...
struct UControlPointMeshComponent : UStaticMeshComponent {
	float VirtualTextureMainPassMaxDrawDistance; // 0x520(0x04)
...
struct ALandscapeProxy : AActor {
	...
	void SetLandscapeMaterialVectorParameterValue(struct FName ParameterName, struct FLinearColor Value); // Function Landscape.LandscapeProxy.SetLandscapeMaterialVectorParameterValue // (Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable) // @ game+0x2b5cb38
	void SetLandscapeMaterialTextureParameterValue(struct FName ParameterName, struct UTexture* Value); // Function Landscape.LandscapeProxy.SetLandscapeMaterialTextureParameterValue // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x2b5ca74
	void SetLandscapeMaterialScalarParameterValue(struct FName ParameterName, float Value); // Function Landscape.LandscapeProxy.SetLandscapeMaterialScalarParameterValue // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x2b5c9ac
	bool LandscapeExportHeightmapToRenderTarget(struct UTextureRenderTarget2D* InRenderTarget, bool InExportHeightIntoRGChannel, bool InExportLandscapeProxies); // Function Landscape.LandscapeProxy.LandscapeExportHeightmapToRenderTarget // (Final|Native|Public|BlueprintCallable) // @ game+0x2b5c8c8
	void EditorSetLandscapeMaterial(struct UMaterialInterface* NewLandscapeMaterial); // Function Landscape.LandscapeProxy.EditorSetLandscapeMaterial // (Final|Native|Public|BlueprintCallable) // @ game+0x1d228d0
	void EditorApplySpline(struct USplineComponent* InSplineComponent, float StartWidth, float EndWidth, float StartSideFalloff, float EndSideFalloff, float StartRoll, float EndRoll, int32_t NumSubdivisions, bool bRaiseHeights, bool bLowerHeights, struct ULandscapeLayerInfoObject* PaintLayer, struct FName EditLayerName); // Function Landscape.LandscapeProxy.EditorApplySpline // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x2b5c5cc
	void ChangeUseTessellationComponentScreenSizeFalloff(bool InComponentScreenSizeToUseSubSections); // Function Landscape.LandscapeProxy.ChangeUseTessellationComponentScreenSizeFalloff // (Native|Public|BlueprintCallable) // @ game+0x2b5c548
	void ChangeTessellationComponentScreenSizeFalloff(float InUseTessellationComponentScreenSizeFalloff); // Function Landscape.LandscapeProxy.ChangeTessellationComponentScreenSizeFalloff // (Native|Public|BlueprintCallable) // @ game+0x1d25750
	void ChangeTessellationComponentScreenSize(float InTessellationComponentScreenSize); // Function Landscape.LandscapeProxy.ChangeTessellationComponentScreenSize // (Native|Public|BlueprintCallable) // @ game+0x2b5c4c0
	void ChangeLODDistanceFactor(float InLODDistanceFactor); // Function Landscape.LandscapeProxy.ChangeLODDistanceFactor // (Native|Public|BlueprintCallable) // @ game+0x2b5c438
	void ChangeComponentScreenSizeToUseSubSections(float InComponentScreenSizeToUseSubSections); // Function Landscape.LandscapeProxy.ChangeComponentScreenSizeToUseSubSections // (Native|Public|BlueprintCallable) // @ game+0x2b5c3b0
};
...
struct ALandscapeBlueprintBrushBase : AActor {
	...
	void RequestLandscapeUpdate(); // Function Landscape.LandscapeBlueprintBrushBase.RequestLandscapeUpdate // (Final|Native|Public|BlueprintCallable) // @ game+0x1521dbc
	struct UTextureRenderTarget2D* Render(bool InIsHeightmap, struct UTextureRenderTarget2D* InCombinedResult, struct FName& InWeightmapLayerName); // Function Landscape.LandscapeBlueprintBrushBase.Render // (Native|Event|Public|HasOutParms|BlueprintEvent) // @ game+0x2b5ad00
	void Initialize(struct FTransform& InLandscapeTransform, struct FIntPoint& InLandscapeSize, struct FIntPoint& InLandscapeRenderTargetSize); // Function Landscape.LandscapeBlueprintBrushBase.Initialize // (Native|Event|Public|HasOutParms|HasDefaults|BlueprintEvent) // @ game+0x2b5aba0
	void GetBlueprintRenderDependencies(struct TArray<struct UObject*>& OutStreamableAssets); // Function Landscape.LandscapeBlueprintBrushBase.GetBlueprintRenderDependencies // (Event|Public|HasOutParms|BlueprintEvent) // @ game+0x201e6d4
};
...
// Size: 0x6b0 (Inherited: 0x490)
struct ULandscapeComponent : UPrimitiveComponent {
	int32_t SectionBaseX; // 0x490(0x04)
	int32_t SectionBaseY; // 0x494(0x04)
	int32_t ComponentSizeQuads; // 0x498(0x04)
	int32_t SubsectionSizeQuads; // 0x49c(0x04)
	int32_t NumSubsections; // 0x4a0(0x04)
	char pad_4A4[0x4]; // 0x4a4(0x04)
	struct UMaterialInterface* OverrideMaterial; // 0x4a8(0x08)
	struct UMaterialInterface* OverrideHoleMaterial; // 0x4b0(0x08)
	struct TArray<struct FLandscapeComponentMaterialOverride> OverrideMaterials; // 0x4b8(0x10)
	struct TArray<struct UMaterialInstanceConstant*> MaterialInstances; // 0x4c8(0x10)
	struct TArray<struct UMaterialInstanceDynamic*> MaterialInstancesDynamic; // 0x4d8(0x10)
	struct TArray<int8_t> LODIndexToMaterialIndex; // 0x4e8(0x10)
	struct TArray<int8_t> MaterialIndexToDisabledTessellationMaterial; // 0x4f8(0x10)
	struct UTexture2D* XYOffsetmapTexture; // 0x508(0x08)
	struct FVector4 WeightmapScaleBias; // 0x510(0x10)
	float WeightmapSubsectionOffset; // 0x520(0x04)
	char pad_524[0xc]; // 0x524(0x0c)
	struct FVector4 HeightmapScaleBias; // 0x530(0x10)
	struct FBox CachedLocalBox; // 0x540(0x1c)
	LazyObjectProperty CollisionComponent; // 0x55c(0x1c)
	struct UTexture2D* HeightmapTexture; // 0x578(0x08)
	struct TArray<struct FWeightmapLayerAllocationInfo> WeightmapLayerAllocations; // 0x580(0x10)
	struct TArray<struct UTexture2D*> WeightmapTextures; // 0x590(0x10)
	struct ULandscapeLODStreamingProxy* LODStreamingProxy; // 0x5a0(0x08)
	struct FGuid MapBuildDataId; // 0x5a8(0x10)
	struct TArray<struct FGuid> IrrelevantLights; // 0x5b8(0x10)
	int32_t CollisionMipLevel; // 0x5c8(0x04)
	int32_t SimpleCollisionMipLevel; // 0x5cc(0x04)
	float NegativeZBoundsExtension; // 0x5d0(0x04)
	float PositiveZBoundsExtension; // 0x5d4(0x04)
	float StaticLightingResolution; // 0x5d8(0x04)
	int32_t ForcedLOD; // 0x5dc(0x04)
	int32_t LODBias; // 0x5e0(0x04)
	struct FGuid StateId; // 0x5e4(0x10)
	struct FGuid BakedTextureMaterialGuid; // 0x5f4(0x10)
	char pad_604[0x4]; // 0x604(0x04)
	struct UTexture2D* GIBakedBaseColorTexture; // 0x608(0x08)
	char MobileBlendableLayerMask; // 0x610(0x01)
	char pad_611[0x7]; // 0x611(0x07)
	struct UMaterialInterface* MobileMaterialInterface; // 0x618(0x08)
	struct TArray<struct UMaterialInterface*> MobileMaterialInterfaces; // 0x620(0x10)
	struct TArray<struct UTexture2D*> MobileWeightmapTextures; // 0x630(0x10)
	char pad_640[0x70]; // 0x640(0x70)

	struct UMaterialInstanceDynamic* GetMaterialInstanceDynamic(int32_t InIndex); // Function Landscape.LandscapeComponent.GetMaterialInstanceDynamic // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x2b5aac8
	float EditorGetPaintLayerWeightByNameAtLocation(struct FVector& InLocation, struct FName InPaintLayerName); // Function Landscape.LandscapeComponent.EditorGetPaintLayerWeightByNameAtLocation // (Final|RequiredAPI|Native|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0x2b5aa1c
	float EditorGetPaintLayerWeightAtLocation(struct FVector& InLocation, struct ULandscapeLayerInfoObject* PaintLayer); // Function Landscape.LandscapeComponent.EditorGetPaintLayerWeightAtLocation // (Final|RequiredAPI|Native|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0x2b5a974
};
...
struct ULandscapeHeightfieldCollisionComponent : UPrimitiveComponent {
	struct TArray<struct ULandscapeLayerInfoObject*> ComponentLayerInfos; // 0x490(0x10)
	int32_t SectionBaseX; // 0x4a0(0x04)
	int32_t SectionBaseY; // 0x4a4(0x04)
	int32_t CollisionSizeQuads; // 0x4a8(0x04)
	float CollisionScale; // 0x4ac(0x04)
	int32_t SimpleCollisionSizeQuads; // 0x4b0(0x04)
	char pad_4B4[0x4]; // 0x4b4(0x04)
	struct TArray<char> CollisionQuadFlags; // 0x4b8(0x10)
	struct FGuid HeightfieldGuid; // 0x4c8(0x10)
	struct FBox CachedLocalBox; // 0x4d8(0x1c)
	LazyObjectProperty RenderComponent; // 0x4f4(0x1c)
	char pad_510[0x10]; // 0x510(0x10)
	struct TArray<struct UPhysicalMaterial*> CookedPhysicalMaterials; // 0x520(0x10)
	char pad_530[0x40]; // 0x530(0x40)

	struct ULandscapeComponent* GetRenderComponent(); // Function Landscape.LandscapeHeightfieldCollisionComponent.GetRenderComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x2b5ab7c
};
...
struct ULandscapeMaterialInstanceConstant : UMaterialInstanceConstant {
	...
	char bIsLayerThumbnail : 1; // 0x328(0x01)
	char bDisableTessellation : 1; // 0x328(0x01)
	char bMobile : 1; // 0x328(0x01)
	char bEditorToolUsage : 1; // 0x328(0x01)
	char pad_328_4 : 4; // 0x328(0x01)
...
struct ULandscapeMeshCollisionComponent : ULandscapeHeightfieldCollisionComponent {
	struct FGuid MeshGuid; // 0x570(0x10)
...
struct ULandscapeMeshProxyComponent : UStaticMeshComponent {
	struct FGuid LandscapeGuid; // 0x520(0x10)
	struct TArray<struct FIntPoint> ProxyComponentBases; // 0x530(0x10)
	int8_t ProxyLOD; // 0x540(0x01)
...
struct ULandscapeSplinesComponent : UPrimitiveComponent {
	struct TArray<struct ULandscapeSplineControlPoint*> ControlPoints; // 0x490(0x10)
	struct TArray<struct ULandscapeSplineSegment*> Segments; // 0x4a0(0x10)
	struct TArray<struct UMeshComponent*> CookedForeignMeshComponents; // 0x4b0(0x10)

	struct TArray<struct USplineMeshComponent*> GetSplineMeshComponents(); // Function Landscape.LandscapeSplinesComponent.GetSplineMeshComponents // (Final|Native|Public|BlueprintCallable) // @ game+0x2b5e5bc
};
