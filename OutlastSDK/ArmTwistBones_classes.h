...
struct UArmTwistBones_C : UAnimInstance {
	...
	void AnimGraph(struct FPoseLink InPose, struct FPoseLink& AnimGraph); // Function ArmTwistBones.ArmTwistBones_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x201e6d4
	void ExecuteUbergraph_ArmTwistBones(int32_t EntryPoint); // Function ArmTwistBones.ArmTwistBones_C.ExecuteUbergraph_ArmTwistBones // (Final|UbergraphFunction) // @ game+0x201e6d4
};
