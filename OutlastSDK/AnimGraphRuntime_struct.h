...
struct FAnimNode_BlendListBase : FAnimNode_Base {
	...
	bool bBlendRootMotion; // 0x48(0x01)
	char pad_49[0x7]; // 0x49(0x07)
	struct TArray<struct FAlphaBlend> Blends; // 0x50(0x10)
...
struct FAnimNode_BlendListByEnum : FAnimNode_BlendListBase {
	struct TArray<int32_t> EnumToPoseIndex; // 0xa0(0x10)
	char ActiveEnumValue; // 0xb0(0x01)
...
struct FAnimNode_BlendListByInt : FAnimNode_BlendListBase {
	int32_t ActiveChildIndex; // 0xa0(0x04)
...
struct FAnimNode_CopyPoseFromMesh : FAnimNode_Base {
	...
	bool bCopyRootMotion; // 0x24(0x01)
	char pad_25[0x1b3]; // 0x25(0x1b3)
};
...
struct FAnimNode_RigidBody : FAnimNode_SkeletalControlBase {
	...
	char pad_208[0x628]; // 0x208(0x628)
};
